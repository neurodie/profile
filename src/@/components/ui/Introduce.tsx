...
export default function Introduces() {
    ...
    return (
        <div id="about" className="relative w-full my-32">
            <div className="absolute top-0 left-0 w-full h-1/2 bg-gradient-to-t from-transparent to-gray-100 dark:to-zinc-800/30 -z-10" />
            <div className="md:w-11/12 lg:w-9/12 mx-auto lg:p-6 h-full">
                <div className="w-full flex flex-col-reverse lg:flex-row justify-between items-center mt-24">
                    ...
                    <div className="w-11/12 md:w-1/2 flex flex-col justify-around">
                        ...
                        <h2 className="text-gray-500 dark:text-gray-300  text-lg lg:text-2xl font-serif text-left">
                        ...
                        <div className="flex justify-start items-center gap-10">
                            <span className="flex gap-3 items-center">
                                ...
                                <a
                                    ...
                                    target="_blank"
                                    className="text-gray-700 dark:text-gray-50 hover:text-emerald-400"
                                    rel="noreferrer"
                                >
                                    Github
                                </a>
