    ...
    const contacts = [
        {
            id: 1,
            name: 'Email',
            value: 'huda123semoi@gmail.com',
            icon: 'mail-outline',
        },
        {
            id: 4,
            name: 'Address',
            value: 'Sepaku, Penajam Paser Utara',
            ...
            <div className="container mx-auto px-0">
                ...
                <div className="flex flex-col flex-wrap lg:flex-row">
                    <div className="w-full lg:w-1/2 lg:px-2">
                        <div className="w-full">
                            <h2 className="font-sans text-gray-600 dark:text-gray-50">
                                Contact Info
                            </h2>
                        </div>
                        ...
                        >
                            <div className="flex flex-wrap">
                                ...
                                <div className="w-full mt-4 md:px-0 flex flex-col-reverse md:flex-row gap-2 items-center justify-between">
                                    <button
                                        type="submit"
                                        className="bg-emerald-500 hover:bg-emerald-500 text-black font-medium py-2 px-4 rounded focus:outline-none focus:shadow-outline"
                                    >
                                        Submit
                                    </button>
